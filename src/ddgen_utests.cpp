...
TEST_CASE("Rtp Header Tests", "[RtpHeaderType]")
{
    ...
    {
        ddgen::RtpHeaderType rtp_header;
    ...
    {
        unsigned char line_rtp[ddgen::rtp_header_size];
        sample_rtp_header.WriteToBuffer(line_rtp);

        REQUIRE(0 == std::memcmp(sample_line_rtp_header, line_rtp, ddgen::rtp_header_size));
    }
}
...
TEST_CASE("Ipv4 Header Tests", "[Ipv4HeaderType]")
{
    ...
    {
        ddgen::Ipv4HeaderType ipv4_header;
    ...
    SECTION("calculating checksum and writing ipv4 header to array ")
    {
        ...
        REQUIRE(true == ddgen::CheckIpv4Checksum(line_ipv4));
        REQUIRE(0 == std::memcmp(sample_line_ipv4_header, line_ipv4, ddgen::ipv4_header_size));
    }
}
...
TEST_CASE("Udp Header Tests", "[UdpHeaderType]")
{
    ...
    {
        ddgen::UdpHeaderType udp_header;
    ...
    SECTION("calculating checksum and writing udp header to array ")
    {
        ...
        ddgen::PseudoIpv4HeaderType pseudo_ipv4_header;
        ...
        unsigned char line_udp[ddgen::udp_header_size + sizeof(sample_line_rtp_packet)];
        // copy udp data with sample
        std::memcpy((line_udp + ddgen::udp_header_size), sample_line_rtp_packet, sizeof(sample_line_rtp_packet));
        ...
        REQUIRE(0 == std::memcmp(sample_line_udp_header, line_udp, ddgen::udp_header_size));
    }
}
...
TEST_CASE("Json test", "[JsonType]")
{
    ...
    {
        ddgen::JsonType message_in_json_test1("{\"title\": \"Eternal Sunshine of the Spotless Mind\"}");
        REQUIRE("{\"title\": \"Eternal Sunshine of the Spotless Mind\"}" == message_in_json_test1.ToString());

        ddgen::JsonType message_in_json_test2(" { \"title\"  :   \"Eternal Sunshine of the Spotless Mind\" } ");
        REQUIRE("{\"title\": \"Eternal Sunshine of the Spotless Mind\"}" == message_in_json_test2.ToString());

        ddgen::JsonType message_in_json_test3("{\"title\": \"Eternal Sunshine of the Spotless Mind\", \"year\": \"2004\"}");
        REQUIRE("{\"title\": \"Eternal Sunshine of the Spotless Mind\", \"year\": \"2004\"}" == message_in_json_test3.ToString());

        ddgen::JsonType message_in_json_test4("{\"director\": {\"name\": \"Michel Gondry\"}, \"year\": \"2004\"}");
        REQUIRE("{\"director\": {\"name\": \"Michel Gondry\"}, \"year\": \"2004\"}" == message_in_json_test4.ToString());

        ddgen::JsonType message_in_json_test5("{\"title\": \"Eternal Sunshine of the Spotless Mind\", \"year\": \"2004\", \"cast\" : [{\"name\": "
                                              "\"Jim Carrey\"}, {\"name\": \"Kate Winslet\"}]}");
        REQUIRE("{\"title\": \"Eternal Sunshine of the Spotless Mind\", \"year\": \"2004\", \"cast\": [{\"name\": \"Jim Carrey\"}, {\"name\": \"Kate "
                "Winslet\"}]}"
                == message_in_json_test5.ToString());

        REQUIRE("Eternal Sunshine of the Spotless Mind" == message_in_json_test5["title"]);

        message_in_json_test5.Add("genre", "thriller");
        REQUIRE("{\"title\": \"Eternal Sunshine of the Spotless Mind\", \"year\": \"2004\", \"cast\": [{\"name\": \"Jim Carrey\"}, {\"name\": \"Kate "
                "Winslet\"}], \"genre\": \"thriller\"}"
                == message_in_json_test5.ToString());
        ...
        ddgen::JsonType message_in_json_test6;
        message_in_json_test6.Add("title", "Eternal Sunshine Of The Spotless Mind");
        message_in_json_test6.Add("{\"cast\": [{\"name\": \"Jim\"}, {\"name\": \"Kate\"}]}");
        REQUIRE("{\"title\": \"Eternal Sunshine Of The Spotless Mind\", \"cast\": [{\"name\": \"Jim\"}, {\"name\": \"Kate\"}]}"
                == message_in_json_test6.ToString());

        std::string adaptor = "{\"adaptors\": [{\"name\": \"\\Device\\NPF_{A3A00374-6E04-4A3D-8383-752A280E3B81}\", \"description\": \"Microsoft\", "
                              "\"ip\": \"0.0.0.0\", \"stat\": \"0\"}, {\"name\": \"\\Device\\NPF_{3B50F57D-2855-4B0D-A67C-5223C29458C3}\", "
                              "\"description\": \"Microsoft\", \"ip\": \"192.168.1.7\", \"stat\": \"0\"}]}";
        ddgen::JsonType message_in_json_test7;
        message_in_json_test7.Add("message", "ListAdaptorsAck");
        message_in_json_test7.Add(adaptor);
        REQUIRE("{\"message\": \"ListAdaptorsAck\", \"adaptors\": [{\"name\": \"\\\\Device\\\\NPF_{A3A00374-6E04-4A3D-8383-752A280E3B81}\", "
                "\"description\": \"Microsoft\", \"ip\": \"0.0.0.0\", \"stat\": \"0\"}, {\"name\": "
                "\"\\\\Device\\\\NPF_{3B50F57D-2855-4B0D-A67C-5223C29458C3}\", \"description\": \"Microsoft\", \"ip\": \"192.168.1.7\", \"stat\": "
                "\"0\"}]}"
                == message_in_json_test7.ToString());

        ddgen::JsonType message_in_json_test8("{\"message\": \"IpList\", \"ips\": [\"192.168.2.3\", \"192.168.2.4\", \"192.168.2.5\"]}");
        ...
        REQUIRE("{\"policy\": {\"user\": \"wr\"}, \"new_policy\": {\"group\": \"wrx\"}, \"past_policy\": {\"user\": \"r\"}}"
                == message_in_json_test10.ToString());
        message_in_json_test9.Add(message_in_json_test10.ToString());
        REQUIRE("{\"path\": \"D:\\\\What\\\\the\\\\blepp\", \"policy\": {\"user\": \"wr\"}, \"new_policy\": {\"group\": \"wrx\"}, \"past_policy\": "
                "{\"user\": \"r\"}}"
                == message_in_json_test9.ToString());
    }
}
